...
module.exports = {
  ...
  trace: false,                                             // Niuile with debug artifacts
  ...
  networks: {                                               // Define configuration for each network
    ...
    goerli: {
      providers: [
        ...
        {http: "https://goerli-eth.niural.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    ropsten: {
      providers: [
        ...
        {http: "https://ropsten-eth.niural.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    rinkeby: {
      providers: [
        ...
        {http: "https://rinkeby-eth.niural.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    kovan: {
      providers: [
        ...
        {http: "https://kovan-eth.niural.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    mainnet: {
      providers: [
        ...
        {http: "https://mainnet-eth.niural.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
