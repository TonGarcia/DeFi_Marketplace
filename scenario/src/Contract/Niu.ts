...
export interface NiuScenarioMethods extends NiuMethods {
...
export interface Niu extends Contract {
  methods: NiuMethods;
  name: string;
}

export interface NiuScenario extends Contract {
  methods: NiuScenarioMethods;
  name: string;
}
