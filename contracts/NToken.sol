...
contract NToken is NTokenInterface, Exponential, TokenErrorReporter {
     ...
     */
    function initialize(NiutrollerInterface comptroller_,
        ...
        // Set the comptroller
        uint err = _setNiutroller(comptroller_);
    ...
    function _setNiutroller(NiutrollerInterface newNiutroller) public returns (uint) {
        ...
        NiutrollerInterface oldNiutroller = comptroller;
        // Ensure invoke comptroller.isNiutroller() returns true
        require(newNiutroller.isNiutroller(), "marker method returned false");

        // Set market's comptroller to newNiutroller
        comptroller = newNiutroller;
